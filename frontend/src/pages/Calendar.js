  ...
  return (
    <div className="page animate-fade-in">
      ...
      <div className="p-4 md:p-6 flex flex-col md:flex-row gap-6 max-w-7xl mx-auto w-full items-start">
          ...
          <div className="card" style={{ padding: 16 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
              ...
              <button
                ...
                style={{ opacity: (calYear === today.getFullYear() && calMonth === today.getMonth()) ? 0.25 : 1 }}
              >
        ...
        {/* Right Side: Report details for selected date */}
        <div className="flex-1 w-full flex flex-col gap-4">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid var(--border)', paddingBottom: 10 }}>
            <h3 style={{ fontSize: 15, color: 'var(--text-primary)' }}>Daily Activity Report</h3>
            <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--accent-gold)' }}>
